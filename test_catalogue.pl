...
type_instance(measurement_of_b, component_type, [fields([component_ref(amount, measurement, false, rel), component_ref(ref_to_b, b, false, rel)]), views([])]).
...
type_instance(customer, dimension_type, [fields([property(name, string), component_ref(address, address, false, rel)]), views([])]).
...
type_instance(a, dimension_type, [fields([unique(not_key, fields([component_ref(unique_ref_to_b, b, false, rel)])), component_ref(ref_to_b, b, false, rel), collection(set, set_unique_of_b, no_parent, fields([unique(not_key, fields([component_ref(ref_to_b, b, false, rel)]))])), collection(set, set_of_b, no_parent, fields([component_ref(ref_to_b, b, false, rel)])), collection(bag, bag_of_b, no_parent, fields([component_ref(ref_to_b, b, false, rel)])), collection(list, list_of_b, no_parent, fields([component_ref(ref_to_b, b, false, rel)])), collection(map(string, key), map_of_b, no_parent, fields([component_ref(value, b, false, rel)])), component_ref(ref_to_c, c, false, rel), component_ref(ref_to_d, d, false, rel), collection(set, set_of_c, no_parent, fields([component_ref(ref_to_c, c, false, rel)])), collection(set, set_of_d, no_parent, fields([component_ref(ref_to_d, d, false, rel)])), collection(set, set_of_things_ref_back, parent(ref_to_parent), fields([])), collection(list, list_of_things_ref_back, parent(ref_to_parent), fields([])), collection(bag, bag_of_things_ref_back, parent(ref_to_parent), fields([])), collection(map(string, key), map_of_things_ref_back, parent(ref_to_parent), fields([])), collection(set, list_of_amount_of_b, no_parent, fields([property(quantity, integer), component_ref(ref_to_b, b, false, rel)])), collection(set, list_of_measurement_of_b, no_parent, fields([component_ref(amount, measurement, false, rel), component_ref(ref_to_b, b, false, rel)])), collection(set, list_of_ref_to_measurement_of_b, no_parent, fields([component_ref(measurement_of_b, measurement_of_b, false, rel)]))]), views([])]).
type_instance(b, dimension_type, [fields([]), views([])]).
type_instance(c, dimension_type, [fields([component_ref(ref_to_a, a, false, rel)]), views([])]).
type_instance(d, dimension_type, [fields([collection(set, set_of_a, no_parent, fields([component_ref(ref_to_a, a, false, rel)]))]), views([])]).
type_instance(store, dimension_type, [fields([component_ref(address, address, false, rel)]), views([])]).
...
type_instance(purchase_order, entity_type, [fields([component_ref(customer, customer, false, rel), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, rel), property(quantity, integer)])), property(state, order_state), component_ref(billing, billing_details, false, rel)]), views([completed_purchase_order])]).
type_instance(completed_purchase_order, view_type, [fields([component_ref(customer, customer, false, rel), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, rel), property(quantity, integer)]))]), views([])]).
type_instance(retail_sale, component_type, [fields([component_ref(customer, customer, false, rel), component_ref(store, store, false, rel), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, rel), property(quantity, integer)]))]), views([])]).
type_instance(pos_sale1, fact_type, [fields([component_ref(customer, customer, false, rel), component_ref(store, store, false, rel), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, rel), property(quantity, integer)]))]), views([])]).
type_instance(pos_sale2, fact_type, [fields([component_ref(retail_sale, retail_sale, false, rel)]), views([])]).
type_instance(pos_sale3, fact_type, [fields([component_ref(retail_sale, retail_sale, false, rel), property(cost, real), property(profit, real)]), views([])]).
type_instance(order1, fact_type, [fields([component_ref(purchase_order, purchase_order, false, rel)]), views([])]).
type_instance(order2, fact_type, [fields([component_ref(purchase_order, purchase_order, false, rel), property(date, date), property(time, time)]), views([])]).
type_instance(order3, fact_type, [fields([component_ref(purchase_order, purchase_order, false, rel), property(price, real), property(total_order_price, real), property(date, date), property(time, time)]), views([])]).
type_instance(order_transaction, fact_type, [fields([component_ref(completed_purchase_order, completed_purchase_order, false, rel), extend(extend_ref(completed_purchase_order, line_item), fields([property(price, real)])), property(total_order_price, real), property(date, date), property(time, time)]), views([])]).
type_instance(market_basket, fact_type, [fields([component_ref(customer, customer, false, rel), component_ref(store, store, false, rel), component_ref(product_a, example_product, false, rel), component_ref(product_b, example_product, false, rel), property(basket_count, integer), property(quantity_a, integer), property(quantity_b, integer), property(price_a, real), property(price_b, real)]), views([])]).
