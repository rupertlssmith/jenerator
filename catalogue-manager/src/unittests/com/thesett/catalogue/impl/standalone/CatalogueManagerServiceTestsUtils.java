...
/**
 * CatalogueManagerServiceTestsUtils provides a set of callback methods for writing tests that use the
 * {@link CatalogueManagerService}. This allows the tests to be written in a deployment neutral way, for example using
 * explicit or container managed transactions, remote proxies, and so on.
 *
