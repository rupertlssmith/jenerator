...
type_instance(customer, dimension_type, [fields([property(name, string), component_ref(address, address, false, _)]), views([])]).
...
type_instance(purchase_order, entity_type, [fields([component_ref(customer, customer, false, _), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, _), property(quantity, integer)])), property(state, order_state), component_ref(billing, billing_details, false, _)]), views([completed_purchase_order])]).
type_instance(completed_purchase_order, view_type, [fields([component_ref(customer, customer, false, _), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, _), property(quantity, integer)]))]), views([])]).
type_instance(retail_sale, component_type, [fields([component_ref(customer, customer, false, _), component_ref(store, store, false, _), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, _), property(quantity, integer)]))]), views([])]).
type_instance(pos_sale1, fact_type, [fields([component_ref(customer, customer, false, _), component_ref(store, store, false, _), collection(bag, line_item, no_parent, fields([component_ref(product, example_product, false, _), property(quantity, integer)]))]), views([])]).
type_instance(pos_sale2, fact_type, [fields([component_ref(retail_sale, retail_sale, false, _)]), views([])]).
type_instance(pos_sale3, fact_type, [fields([component_ref(retail_sale, retail_sale, false, _), property(cost, real), property(profit, real)]), views([])]).
type_instance(order1, fact_type, [fields([component_ref(purchase_order, purchase_order, false, _)]), views([])]).
type_instance(order2, fact_type, [fields([component_ref(purchase_order, purchase_order, false, _), property(date, date), property(time, time)]), views([])]).
type_instance(order3, fact_type, [fields([component_ref(purchase_order, purchase_order, false, _), property(price, real), property(total_order_price, real), property(date, date), property(time, time)]), views([])]).
type_instance(order_transaction, fact_type, [fields([component_ref(completed_purchase_order, completed_purchase_order, false, _), extend(extend_ref(completed_purchase_order, line_item), fields([property(price, real)])), property(total_order_price, real), property(date, date), property(time, time)]), views([])]).
type_instance(market_basket, fact_type, [fields([component_ref(customer, customer, false, _), component_ref(store, store, false, _), component_ref(product_a, example_product, false, _), component_ref(product_b, example_product, false, _), property(basket_count, integer), property(quantity_a, integer), property(quantity_b, integer), property(price_a, real), property(price_b, real)]), views([])]).
