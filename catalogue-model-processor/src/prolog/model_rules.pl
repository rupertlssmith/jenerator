...
/* These rules expand integer ranges with only a from or a to specified to use the narrowest Java type available. */
...
/* These rules expand integer ranges to use either a java int or long depending on the size of the from and to. */
...
/* These rules expand real ranges with only a from or a to specified to appropriate limits depending on the precision. */
...
/* These rules expand real ranges to use either a java float or double depending on the size of the from and to. */
