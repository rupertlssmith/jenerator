 ...
 * @author Rupert Smith
 */
public class ProtoIndexTestPerf extends TestCase
{
    /** Used for logging. */
    private static final Logger log = Logger.getLogger(ProtoIndexTestPerf.class);

    public ProtoIndexTestPerf(String testName)
    {
        super(testName);
    }
    ...
    public static Test suite()
    {
        ...
        TestSuite suite = new TestSuite("ProtoIndex Performance Tests");
        ...
        suite.addTest(new TransactionalIndexPerfTestBase("testIndexPerformance", readCommittedIndex,
                readCommittedIndex));
